    ...
    public void BaseUrl(@Optional("http://gamma.xe.com/") String url, @Optional("firefoxLocal")String browser) throws MalformedURLException, InterruptedException {	
		...
		baseUrl = url;
         ...
         public void a_redirectToXeMt() throws InterruptedException {
		   ...
		   String text18 =   lasttabs.region_UI.get(9).getText();
		   Assert.assertEquals(text18,"BGN Bulgarian Lev");
		   String text19 =   lasttabs.region_UI.get(10).getText();
		   Assert.assertEquals(text19,"CHF Swiss Franc");
		   String text20 =   lasttabs.region_UI.get(11).getText();
		   Assert.assertEquals(text20,"CZK Czech Koruna");
		   String text21 =   lasttabs.region_UI.get(12).getText();
		   Assert.assertEquals(text21,"DKK Danish Krone");
		   String text22 =   lasttabs.region_UI.get(13).getText();
		   Assert.assertEquals(text22,"EUR Euro");
		   String text23 =   lasttabs.region_UI.get(14).getText();
		   Assert.assertEquals(text23,"GBP British Pound");
		   String text24 =   lasttabs.region_UI.get(15).getText();
		   Assert.assertEquals(text24,"HRK Croatian Kuna");
		   String text25 =   lasttabs.region_UI.get(16).getText();
		   Assert.assertEquals(text25,"HUF Hungarian Forint");
		   String text26 =   lasttabs.region_UI.get(17).getText();
		   Assert.assertEquals(text26,"ILS Israeli Shekel");
		   String text27 =   lasttabs.region_UI.get(18).getText();
		   Assert.assertEquals(text27,"NOK Norwegian Krone");
		   String text28 =   lasttabs.region_UI.get(19).getText();
		   Assert.assertEquals(text28,"PLN Polish Zloty");
		   String text29 =   lasttabs.region_UI.get(20).getText();
		   Assert.assertEquals(text29,"RON Romanian Leu");
		   String text30 =   lasttabs.region_UI.get(21).getText();
		   Assert.assertEquals(text30,"RSD Serbian Dinar");
		   String text31 =   lasttabs.region_UI.get(22).getText();
		   Assert.assertEquals(text31,"SEK Swedish Krona");
		   String text32 =   lasttabs.region_UI.get(23).getText();
		   Assert.assertEquals(text32,"TRY Turkish Lira");
		   String text33 =   lasttabs.region_UI.get(24).getText();
		   Assert.assertEquals(text33,"BWP Botswana Pula");
		   String text34 =   lasttabs.region_UI.get(25).getText();
		   Assert.assertEquals(text34,"GHS Ghanaian Cedi*");
		   String text35 =   lasttabs.region_UI.get(26).getText();
		   Assert.assertEquals(text35,"KES Kenyan Shilling");
		   String text36 =   lasttabs.region_UI.get(27).getText();
		   Assert.assertEquals(text36,"LSL Basotho Loti");
		   String text37 =   lasttabs.region_UI.get(28).getText();
		   Assert.assertEquals(text37,"MUR Mauritian Rupee");
		   String text38 =   lasttabs.region_UI.get(29).getText();
		   Assert.assertEquals(text38,"MWK Malawian Kwacha*");
		   String text39 =   lasttabs.region_UI.get(30).getText();
		   Assert.assertEquals(text39,"SZL Swazi Lilangeni");
		   String text40 =   lasttabs.region_UI.get(31).getText();
		   Assert.assertEquals(text40,"TND Tunisian Dinar");
		   String text41 =   lasttabs.region_UI.get(32).getText();
		   Assert.assertEquals(text41,"ZAR South African Rand");
		   String text42 =   lasttabs.region_UI.get(33).getText();
		   Assert.assertEquals(text42,"ZMW Zambian Kwacha*");
		   String text43 =   lasttabs.region_UI.get(34).getText();
		   Assert.assertEquals(text43,"AED Emirati Dirham");
		   String text44 =   lasttabs.region_UI.get(35).getText();
		   Assert.assertEquals(text44,"BHD Bahraini Dinar");
		   String text45 =   lasttabs.region_UI.get(36).getText();
		   Assert.assertEquals(text45,"HKD Hong Kong Dollar");
		   String text46 =   lasttabs.region_UI.get(37).getText();
		   Assert.assertEquals(text46,"INR Indian Rupee");
		   String text47 =   lasttabs.region_UI.get(38).getText();
		   Assert.assertEquals(text47,"JOD Jordanian Dinar");
		   String text48 =   lasttabs.region_UI.get(39).getText();
		   Assert.assertEquals(text48,"JPY Japanese Yen");
		   String text49 =   lasttabs.region_UI.get(40).getText();
		   Assert.assertEquals(text49,"KWD Kuwaiti Dinar");
		   String text50 =   lasttabs.region_UI.get(41).getText();
		   Assert.assertEquals(text50,"LKR Sri Lankan Rupee*");
		   String text51 =   lasttabs.region_UI.get(42).getText();
		   Assert.assertEquals(text51,"OMR Omani Rial");
		   String text52 =   lasttabs.region_UI.get(43).getText();
		   Assert.assertEquals(text52,"PHP Philippine Peso");
	       String text53 =   lasttabs.region_UI.get(44).getText();
		   Assert.assertEquals(text53,"PKR Pakistani Rupee*");
		   String text54 =   lasttabs.region_UI.get(45).getText();
		   Assert.assertEquals(text54,"QAR Qatari Riyal");
	       String text55 =   lasttabs.region_UI.get(46).getText();
		   Assert.assertEquals(text55,"SAR Saudi Arabian Riyal");
	       String text56 =   lasttabs.region_UI.get(47).getText();
		   Assert.assertEquals(text56,"SGD Singapore Dollar");
		   String text57 =   lasttabs.region_UI.get(48).getText();
		   Assert.assertEquals(text57,"THB Thai Baht");
		   String text58 =   lasttabs.region_UI.get(49).getText();
		   Assert.assertEquals(text58,"AUD Australian Dollar");
		   String text59 =   lasttabs.region_UI.get(50).getText();
		   Assert.assertEquals(text59,"FJD Fijian Dollar");
		   String text60 =   lasttabs.region_UI.get(51).getText();
		   Assert.assertEquals(text60,"NZD New Zealand Dollar");
		   String text61 =   lasttabs.region_UI.get(52).getText();
		   Assert.assertEquals(text61,"PGK Papua New Guinean Kina");
		   String text62 =   lasttabs.region_UI.get(53).getText();
		   Assert.assertEquals(text62,"SBD Solomon Islander Dollar");
		   String text63 =   lasttabs.region_UI.get(54).getText();
		   Assert.assertEquals(text63,"TOP Tongan Pa'anga");
		   String text64 =   lasttabs.region_UI.get(55).getText();
		   Assert.assertEquals(text64,"VUV Ni-Vanuatu Vatu");
		   String text65 =   lasttabs.region_UI.get(56).getText();
		   Assert.assertEquals(text65,"WST Samoan Tala");
		   String text66 =   lasttabs.region_UI.get(57).getText();
		   Assert.assertEquals(text66,"XPF CFP Franc");
