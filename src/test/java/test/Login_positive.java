...
public class Login_positive {
  ...
  public void a_login(){
	  ...
	  homepage.emailLogin_UI.sendKeys("000@ggg.com");
	  homepage.pwdLogin_UI.sendKeys("123456");
	  homepage.loginBtn_UI.click();
      driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS); 
	  
      
      WebElement popup = driver.findElement(By.cssSelector(".modal__content"));
	  Assert.assertTrue(popup.isDisplayed(), "Something wrong with login");
	 }
