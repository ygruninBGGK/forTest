...
public class WeatherKlip_001 extends ParentsTest{
	...
	@Test
	  public void a_login() throws InterruptedException{
		...
		String title = "Today's Weather";
			...
			dash.AddKlip("weather"); // adding the weather to dashboard. The inside function can be improved and used for any Klip
